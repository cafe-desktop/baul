...
typedef GObject BaulSignaller;
typedef GObjectClass BaulSignallerClass;
...
G_DEFINE_TYPE (BaulSignaller, baul_signaller, G_TYPE_OBJECT);
...
static void
baul_signaller_class_init (BaulSignallerClass *class)
{
