...
#define BAUL_TRASH_MONITOR(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST ((obj), BAUL_TYPE_TRASH_MONITOR, CajaTrashMonitor))
#define BAUL_TRASH_MONITOR_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_CAST ((klass), BAUL_TYPE_TRASH_MONITOR, CajaTrashMonitorClass))
...
#define BAUL_TRASH_MONITOR_GET_CLASS(obj) \
  (G_TYPE_INSTANCE_GET_CLASS ((obj), BAUL_TYPE_TRASH_MONITOR, CajaTrashMonitorClass))
