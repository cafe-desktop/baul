...
GtkWidget *baul_widget_view_provider_get_widget     (CajaWidgetViewProvider *provider);
void       baul_widget_view_provider_add_file       (CajaWidgetViewProvider *provider,
                                                     CajaFile *file,
                                                     CajaFile *directory);
void       baul_widget_view_provider_set_location   (CajaWidgetViewProvider *provider,
                                                     const char *location);
void       baul_widget_view_provider_set_window     (CajaWidgetViewProvider *provider,
                                                     GtkWindow *window);
