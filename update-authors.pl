...
=pod
    ...
    update-authors.pl is part of Baul.
    ...
    along with Baul.  If not, see <https://www.gnu.org/licenses/>.
...
sub ReplaceAuthors {
  ...
  $_ eq 'chat-to-me%raveit.de <Nice&Gently>' and $_ = 'Wolfgang Ulbrich <cafe%raveit.de>' for @authors;
