...
#define BAUL_INFORMATION_PANEL(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST ((obj), BAUL_TYPE_INFORMATION_PANEL, BaulInformationPanel))
#define BAUL_INFORMATION_PANEL_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_CAST ((klass), BAUL_TYPE_INFORMATION_PANEL, BaulInformationPanelClass))
...
#define BAUL_INFORMATION_PANEL_GET_CLASS(obj) \
  (G_TYPE_INSTANCE_GET_CLASS ((obj), BAUL_TYPE_INFORMATION_PANEL, BaulInformationPanelClass))

typedef struct _BaulInformationPanelPrivate BaulInformationPanelPrivate;
...
typedef struct
{
    ...
    BaulInformationPanelPrivate *details;
} BaulInformationPanel;

typedef struct
{
    EelBackgroundBoxClass parent_slot;

    void (*location_changed) (BaulInformationPanel *information_panel,
                              const char *location);
} BaulInformationPanelClass;
