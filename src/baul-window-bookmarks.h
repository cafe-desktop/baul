...
void                  baul_window_add_bookmark_for_current_location (BaulWindow *window);
void                  baul_window_edit_bookmarks                    (BaulWindow *window);
void                  baul_window_initialize_bookmarks_menu         (BaulWindow *window);
