 ...
 */
CdkPixbuf *
eel_gdk_pixbuf_scale_to_fit (CdkPixbuf *pixbuf, int max_width, int max_height)
{
    int scaled_width;
    int scaled_height;

    eel_cdk_scale_to_fit_factor (gdk_pixbuf_get_width(pixbuf), gdk_pixbuf_get_height(pixbuf),
 ...
 */
CdkPixbuf *
eel_gdk_pixbuf_scale_down_to_fit (CdkPixbuf *pixbuf, int max_width, int max_height)
{
    int scaled_width;
    int scaled_height;
    ...
    scale_factor = eel_cdk_scale_to_fit_factor (gdk_pixbuf_get_width(pixbuf), gdk_pixbuf_get_height(pixbuf),
                   max_width, max_height,
                   &scaled_width, &scaled_height);
 ...
 */
CdkPixbuf *
eel_gdk_pixbuf_scale_to_min (CdkPixbuf *pixbuf, int min_width, int min_height)
{
    int scaled_width;
    int scaled_height;

    eel_cdk_scale_to_min_factor (gdk_pixbuf_get_width(pixbuf), gdk_pixbuf_get_height(pixbuf),
...
gboolean
eel_gdk_pixbuf_save_to_file (const CdkPixbuf *pixbuf,
                             const char *file_name)
{
    return gdk_pixbuf_save ((CdkPixbuf *) pixbuf,
                            file_name, "png", NULL, NULL);
}

void
eel_gdk_pixbuf_ref_if_not_null (CdkPixbuf *pixbuf_or_null)
{
...
void
eel_gdk_pixbuf_unref_if_not_null (CdkPixbuf *pixbuf_or_null)
{
    if (pixbuf_or_null != NULL)
    {
...
CdkPixbuf *
eel_gdk_pixbuf_scale_down (CdkPixbuf *pixbuf,
                           int dest_width,
                           int dest_height)
{
